...
<div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="pan" name="aadhar" required>
                  	</div>
                </div>


<div class="form-group">
                  	<label for="pan" class="col-sm-3 control-label">Pan No.</label>
...
<div class="form-group">
                  	<label for="pan" class="col-sm-3 control-label">Employee ID</label>
